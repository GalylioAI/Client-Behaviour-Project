...
if (isset($_POST['bt_save_settings']) && check_admin_referer('bt_settings_save', 'bt_settings_nonce')) {
    ...
    foreach ($all_settings as $setting) {
        if (in_array($setting, array('bt_website_id', 'bt_write_key'), true)) {
...
<div class="wrap">
    ...
    <div class="notice notice-info">
        <p><strong>
            ...
            <?php _e('The default webhook is tracker.yatootunisie.tn. Use config.php only if you need to override it.', 'behaviour-tracker'); ?>
        </p>
    </div>

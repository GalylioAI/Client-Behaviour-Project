...
if (isset($_POST['bt_save_settings']) && check_admin_referer('bt_settings_save', 'bt_settings_nonce')) {
    ...
    foreach ($all_settings as $setting) {
        if (in_array($setting, array('bt_website_id', 'bt_webhook_url', 'bt_write_key', 'bt_server_secret_key'), true)) {
...
<div class="wrap">
    ...
    <div class="notice notice-info">
        <p><strong>
            ...
            <?php _e('Paste the site ID, public write key, and server secret from your SaaS setup page. config.php is optional for advanced overrides.', 'behaviour-tracker'); ?>
        </p>
    </div>
    ...
    <form method="post" action="">
        ...
        <div class="bt-section">
            ...
            <p>
                <label for="bt_webhook_url">
                    <strong><?php _e('Webhook URL', 'behaviour-tracker'); ?></strong>
                </label><br>
                <input
                    type="url"
                    id="bt_webhook_url"
                    name="bt_webhook_url"
                    value="<?php echo esc_attr($get_text_option('bt_webhook_url', 'https://tracker.yatootunisie.tn/webhook')); ?>"
                    class="regular-text"
                    placeholder="https://tracker.yatootunisie.tn/webhook"
                >
            </p>
            <p class="description">
                <?php _e('All browser and server events are sent to this endpoint.', 'behaviour-tracker'); ?>
            </p>
            <p>
                <label for="bt_write_key">
                    <strong><?php _e('Public Write Key', 'behaviour-tracker'); ?></strong>
                </label><br>
                <input
                    type="text"
                    id="bt_write_key"
                    name="bt_write_key"
                    value="<?php echo esc_attr($get_text_option('bt_write_key', '')); ?>"
                    class="regular-text"
                    placeholder="pk_live_..."
                >
            </p>
            <p class="description">
                <?php _e('Generated by the SaaS for this website. Browser events use this key together with site_id and allowed domain validation.', 'behaviour-tracker'); ?>
            </p>
            <p>
                <label for="bt_server_secret_key">
                    <strong><?php _e('Server Secret Key', 'behaviour-tracker'); ?></strong>
                </label><br>
                <input
                    type="password"
                    id="bt_server_secret_key"
                    name="bt_server_secret_key"
                    value="<?php echo esc_attr($get_text_option('bt_server_secret_key', '')); ?>"
                    class="regular-text"
            ...
            <p class="description">
                <?php _e('Required for WooCommerce purchases, registrations, and login events sent from PHP. Keep this private.', 'behaviour-tracker'); ?>
            </p>
        </div>

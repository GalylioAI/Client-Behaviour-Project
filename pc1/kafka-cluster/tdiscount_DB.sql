...
-- Kafka Engine -> Materialized View -> MergeTree storage
-- Run on the ClickHouse host when using the tdiscount database name.

CREATE DATABASE IF NOT EXISTS tdiscount;
...
SETTINGS
    ...
    kafka_group_name           = 'clickhouse-ecommerce',
...
-- Quick check:
-- SELECT site_id, platform, event_name, count()
-- FROM ecommerce_events
-- GROUP BY site_id, platform, event_name
-- ORDER BY count() DESC;

...
3. Go to Settings > Behaviour Tracker
4. Paste the website ID, webhook URL, public write key, and server secret key generated by the SaaS

## Configuration

Configure these values in Settings > Behaviour Tracker:
